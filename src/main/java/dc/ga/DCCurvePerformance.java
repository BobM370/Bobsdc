/**
 * The purpose of this class is to report the fitness performance on the testing set
 * of each individual fixed threshold.
 * I'm extending the GA class, with the difference that there's no evolution really happening,
 * as I only allow 1 run, 1 individual, 1 generation, quantities of 1.
 * The point here is not to evolve new individuals,
 * but simply use the fitness calculation capabilities of the GA class
 * and evaluate the performance of each fixed threshold.
