...
public class FReader {
	...
	public static ArrayList<Double[]> loadDataHasOnePrice(String filename)
		...
		while ((line = reader.readLine()) != null)
		{
			...
			// if it does not contain the 10min string, then the file is tick data;
			// if it contains the 10min string, then we go to the else-statement, as the file is 10-min data
