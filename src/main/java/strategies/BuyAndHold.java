...
public class BuyAndHold {
	...
	public BuyAndHold(String filename, int buyIndex, int sellIndex) throws FileNotFoundException, IOException{
		...
		//if user enters the same buyIndex and sellIndex, this means that we will buy at the beginning
		// of the day, and sell at the end of the very same day.
		// That's why the else-statement sets the 'end' data equal to the data derived from the *buy*
		// (i.e., start) index.
		// If buyIndex and sellIndex are different values, then we go to the if-part of the statement,
		// which sets the 'end' data equal to the data derived from the *sell* (i.e., end) index.
